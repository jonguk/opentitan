...
package rstmgr_reg_pkg;
  ...
  parameter int NumHwResets = 1;
  parameter int NumSwResets = 1;
  parameter int NumTotalResets = 4;
  ...
  typedef struct packed {
    ...
    rstmgr_reg2hw_reset_info_reg_t reset_info; // [15:14]
  ...
  // HW -> register type
  typedef struct packed {
    rstmgr_hw2reg_reset_req_reg_t reset_req; // [92:88]
    rstmgr_hw2reg_reset_info_reg_t reset_info; // [87:82]
