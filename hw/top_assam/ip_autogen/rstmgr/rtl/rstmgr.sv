...
#(
  ...
  logic [9:0][PowerDomains-1:0] cnsty_chk_errs;
  logic [9:0][PowerDomains-1:0] shadow_cnsty_chk_errs;

  // consistency sparse fsm errors
  logic [9:0][PowerDomains-1:0] fsm_errs;
  logic [9:0][PowerDomains-1:0] shadow_fsm_errs;
  ...
  assign resets_o.rst_lc_n[Domain0Sel] = '0;
  assign cnsty_chk_errs[4][Domain0Sel] = '0;
  assign fsm_errs[4][Domain0Sel] = '0;
  assign rst_en_o.lc[Domain0Sel] = MuBi4True;
  ...
  assign shadow_cnsty_chk_errs[6][DomainAonSel] = '0;
  assign shadow_fsm_errs[6][DomainAonSel] = '0;
  ...
  rstmgr_leaf_rst #(
    ...
    .fsm_err_o(shadow_fsm_errs[6][Domain0Sel])
  );
