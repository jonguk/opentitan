...
package clkmgr_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    clkmgr_reg2hw_alert_test_reg_t alert_test; // [66:63]
    clkmgr_reg2hw_extclk_ctrl_reg_t extclk_ctrl; // [62:55]
    clkmgr_reg2hw_jitter_enable_reg_t jitter_enable; // [54:51]
    clkmgr_reg2hw_clk_enables_reg_t clk_enables; // [50:49]
    clkmgr_reg2hw_clk_hints_reg_t clk_hints; // [48:48]
  ...
  // HW -> register type
  typedef struct packed {
    clkmgr_hw2reg_extclk_status_reg_t extclk_status; // [33:30]
    clkmgr_hw2reg_clk_hints_status_reg_t clk_hints_status; // [29:28]
    clkmgr_hw2reg_measure_ctrl_regwen_reg_t measure_ctrl_regwen; // [27:26]
    clkmgr_hw2reg_io_div4_meas_ctrl_en_reg_t io_div4_meas_ctrl_en; // [25:21]
  ...
  parameter logic [BlockAw-1:0] CLKMGR_IO_DIV4_MEAS_CTRL_EN_OFFSET = 6'h 28;
