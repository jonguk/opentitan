...
package pwrmgr_reg_pkg;
  ...
  parameter int NumIntRstReqs = 1;
  parameter int NumDebugRstReqs = 0;
  ...
  // Register -> HW type
  typedef struct packed {
    pwrmgr_reg2hw_intr_state_reg_t intr_state; // [23:23]
    pwrmgr_reg2hw_intr_enable_reg_t intr_enable; // [22:22]
    pwrmgr_reg2hw_intr_test_reg_t intr_test; // [21:20]
    pwrmgr_reg2hw_alert_test_reg_t alert_test; // [19:18]
    pwrmgr_reg2hw_control_reg_t control; // [17:14]
    pwrmgr_reg2hw_cfg_cdc_sync_reg_t cfg_cdc_sync; // [13:12]
    pwrmgr_reg2hw_wakeup_en_mreg_t [0:0] wakeup_en; // [11:11]
    pwrmgr_reg2hw_reset_en_mreg_t [0:0] reset_en; // [10:10]
    pwrmgr_reg2hw_wake_info_capture_dis_reg_t wake_info_capture_dis; // [9:9]
    pwrmgr_reg2hw_wake_info_reg_t wake_info; // [8:3]
  ...
  typedef struct packed {
    ...
    pwrmgr_hw2reg_wake_status_mreg_t [0:0] wake_status; // [14:13]
    pwrmgr_hw2reg_reset_status_mreg_t [0:0] reset_status; // [12:11]
    pwrmgr_hw2reg_escalate_reset_status_reg_t escalate_reset_status; // [10:9]
    pwrmgr_hw2reg_wake_info_reg_t wake_info; // [8:6]
