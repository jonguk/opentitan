...
class mbx_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(mbx_window_seq);
  explicit mbx_window_seq(const std::string &nm = "mbx_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
