...
class mbx_regwen_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(mbx_regwen_seq);
  explicit mbx_regwen_seq(const std::string &nm = "mbx_regwen_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
