...
class mbx_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(mbx_bit_bash_seq);
  explicit mbx_bit_bash_seq(const std::string &nm = "mbx_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
