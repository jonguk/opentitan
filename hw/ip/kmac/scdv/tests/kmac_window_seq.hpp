...
class kmac_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(kmac_window_seq);
  explicit kmac_window_seq(const std::string &nm = "kmac_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
