...
class kmac_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(kmac_racl_seq);
  explicit kmac_racl_seq(const std::string &nm = "kmac_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
