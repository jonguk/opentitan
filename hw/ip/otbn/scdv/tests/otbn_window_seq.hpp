...
class otbn_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otbn_window_seq);
  explicit otbn_window_seq(const std::string &nm = "otbn_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
