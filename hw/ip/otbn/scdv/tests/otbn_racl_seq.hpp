...
class otbn_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otbn_racl_seq);
  explicit otbn_racl_seq(const std::string &nm = "otbn_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
