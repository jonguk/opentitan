...
class otbn_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otbn_bit_bash_seq);
  explicit otbn_bit_bash_seq(const std::string &nm = "otbn_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
