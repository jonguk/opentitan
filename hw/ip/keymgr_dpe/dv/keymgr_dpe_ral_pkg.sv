...
package keymgr_dpe_ral_pkg;
  ...
  typedef class keymgr_dpe_reg_intr_state;
  typedef class keymgr_dpe_reg_intr_enable;
  typedef class keymgr_dpe_reg_intr_test;
  typedef class keymgr_dpe_reg_alert_test;
  typedef class keymgr_dpe_reg_cfg_regwen;
  typedef class keymgr_dpe_reg_start;
  typedef class keymgr_dpe_reg_control_shadowed;
  typedef class keymgr_dpe_reg_sideload_clear;
  typedef class keymgr_dpe_reg_reseed_interval_regwen;
  typedef class keymgr_dpe_reg_reseed_interval_shadowed;
  typedef class keymgr_dpe_reg_slot_policy_regwen;
  typedef class keymgr_dpe_reg_slot_policy;
  typedef class keymgr_dpe_reg_sw_binding_regwen;
  typedef class keymgr_dpe_reg_sw_binding;
  typedef class keymgr_dpe_reg_salt;
  typedef class keymgr_dpe_reg_key_version;
  typedef class keymgr_dpe_reg_max_key_ver_regwen;
  typedef class keymgr_dpe_reg_max_key_ver_shadowed;
  typedef class keymgr_dpe_reg_sw_share0_output;
  typedef class keymgr_dpe_reg_sw_share1_output;
  typedef class keymgr_dpe_reg_working_state;
  typedef class keymgr_dpe_reg_op_status;
  typedef class keymgr_dpe_reg_err_code;
  typedef class keymgr_dpe_reg_fault_status;
  typedef class keymgr_dpe_reg_debug;
  typedef class keymgr_dpe_reg_block;

  class keymgr_dpe_reg_intr_state extends dv_base_reg;
    // fields
    rand dv_base_reg_field op_done;

    `uvm_object_utils(keymgr_dpe_reg_intr_state)
  ...
  endclass : keymgr_dpe_reg_intr_state

  class keymgr_dpe_reg_intr_enable extends dv_base_reg;
    // fields
    rand dv_base_reg_field op_done;

    `uvm_object_utils(keymgr_dpe_reg_intr_enable)
  ...
  endclass : keymgr_dpe_reg_intr_enable

  class keymgr_dpe_reg_intr_test extends dv_base_reg;
    // fields
    rand dv_base_reg_field op_done;

    `uvm_object_utils(keymgr_dpe_reg_intr_test)
  ...
  endclass : keymgr_dpe_reg_intr_test

  class keymgr_dpe_reg_alert_test extends dv_base_reg;
    // fields
    rand dv_base_reg_field recov_operation_err;
    rand dv_base_reg_field fatal_fault_err;

    `uvm_object_utils(keymgr_dpe_reg_alert_test)
  ...
  endclass : keymgr_dpe_reg_alert_test

  class keymgr_dpe_reg_cfg_regwen extends dv_base_reg;
    // fields
    rand dv_base_reg_field en;

    `uvm_object_utils(keymgr_dpe_reg_cfg_regwen)
  ...
  endclass : keymgr_dpe_reg_cfg_regwen

  class keymgr_dpe_reg_start extends dv_base_reg;
    // fields
    rand dv_base_reg_field en;

    `uvm_object_utils(keymgr_dpe_reg_start)
  ...
  endclass : keymgr_dpe_reg_start

  class keymgr_dpe_reg_control_shadowed extends dv_base_reg;
    // fields
    rand dv_base_reg_field operation;
    rand dv_base_reg_field dest_sel;
    rand dv_base_reg_field slot_src_sel;
    rand dv_base_reg_field slot_dst_sel;

    `uvm_object_utils(keymgr_dpe_reg_control_shadowed)
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      ...
      slot_src_sel =
          (dv_base_reg_field::
           type_id::create("slot_src_sel"));
      slot_src_sel.configure(
        .parent(this),
        .size(2),
        .lsb_pos(14),
        .access("RW"),
      ...
      slot_src_sel.set_original_access("RW");
      slot_dst_sel =
          (dv_base_reg_field::
           type_id::create("slot_dst_sel"));
      slot_dst_sel.configure(
        .parent(this),
        .size(2),
        .lsb_pos(18),
        .access("RW"),
      ...
      slot_dst_sel.set_original_access("RW");
    endfunction : build
  endclass : keymgr_dpe_reg_control_shadowed

  class keymgr_dpe_reg_sideload_clear extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_sideload_clear)
  ...
  endclass : keymgr_dpe_reg_sideload_clear

  class keymgr_dpe_reg_reseed_interval_regwen extends dv_base_reg;
    // fields
    rand dv_base_reg_field en;

    `uvm_object_utils(keymgr_dpe_reg_reseed_interval_regwen)
  ...
  endclass : keymgr_dpe_reg_reseed_interval_regwen

  class keymgr_dpe_reg_reseed_interval_shadowed extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_reseed_interval_shadowed)
  ...
  endclass : keymgr_dpe_reg_reseed_interval_shadowed

  class keymgr_dpe_reg_slot_policy_regwen extends dv_base_reg;
    // fields
    rand dv_base_reg_field en;

    `uvm_object_utils(keymgr_dpe_reg_slot_policy_regwen)
  ...
  endclass : keymgr_dpe_reg_slot_policy_regwen

  class keymgr_dpe_reg_slot_policy extends dv_base_reg;
    // fields
    rand dv_base_reg_field allow_child;
    rand dv_base_reg_field exportable;
    rand dv_base_reg_field retain_parent;

    `uvm_object_utils(keymgr_dpe_reg_slot_policy)
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      allow_child =
          (dv_base_reg_field::
           type_id::create("allow_child"));
      allow_child.configure(
        .parent(this),
        .size(1),
        .lsb_pos(0),
        .access("RW"),
      ...
      allow_child.set_original_access("RW");
      exportable =
          (dv_base_reg_field::
           type_id::create("exportable"));
      exportable.configure(
        .parent(this),
        .size(1),
        .lsb_pos(1),
        .access("RW"),
      ...
      exportable.set_original_access("RW");
      retain_parent =
          (dv_base_reg_field::
           type_id::create("retain_parent"));
      retain_parent.configure(
        .parent(this),
        .size(1),
        .lsb_pos(2),
        .access("RW"),
      ...
      retain_parent.set_original_access("RW");
    endfunction : build
  endclass : keymgr_dpe_reg_slot_policy

  class keymgr_dpe_reg_sw_binding_regwen extends dv_base_reg;
    // fields
    rand dv_base_reg_field en;

    `uvm_object_utils(keymgr_dpe_reg_sw_binding_regwen)
  ...
  endclass : keymgr_dpe_reg_sw_binding_regwen

  class keymgr_dpe_reg_sw_binding extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_sw_binding)
  ...
  endclass : keymgr_dpe_reg_sw_binding

  class keymgr_dpe_reg_salt extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_salt)
  ...
  endclass : keymgr_dpe_reg_salt

  class keymgr_dpe_reg_key_version extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_key_version)
  ...
  endclass : keymgr_dpe_reg_key_version

  class keymgr_dpe_reg_max_key_ver_regwen extends dv_base_reg;
    // fields
    rand dv_base_reg_field en;

    `uvm_object_utils(keymgr_dpe_reg_max_key_ver_regwen)
  ...
  endclass : keymgr_dpe_reg_max_key_ver_regwen

  class keymgr_dpe_reg_max_key_ver_shadowed extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_max_key_ver_shadowed)
  ...
  endclass : keymgr_dpe_reg_max_key_ver_shadowed

  class keymgr_dpe_reg_sw_share0_output extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_sw_share0_output)
  ...
  endclass : keymgr_dpe_reg_sw_share0_output

  class keymgr_dpe_reg_sw_share1_output extends dv_base_reg;
    // fields
    rand dv_base_reg_field val;

    `uvm_object_utils(keymgr_dpe_reg_sw_share1_output)
  ...
  endclass : keymgr_dpe_reg_sw_share1_output

  class keymgr_dpe_reg_working_state extends dv_base_reg;
    // fields
    rand dv_base_reg_field state;

    `uvm_object_utils(keymgr_dpe_reg_working_state)
  ...
  endclass : keymgr_dpe_reg_working_state

  class keymgr_dpe_reg_op_status extends dv_base_reg;
    // fields
    rand dv_base_reg_field status;

    `uvm_object_utils(keymgr_dpe_reg_op_status)
  ...
  endclass : keymgr_dpe_reg_op_status

  class keymgr_dpe_reg_err_code extends dv_base_reg;
    // fields
    rand dv_base_reg_field invalid_op;
    rand dv_base_reg_field invalid_kmac_input;
    rand dv_base_reg_field invalid_shadow_update;

    `uvm_object_utils(keymgr_dpe_reg_err_code)
  ...
  endclass : keymgr_dpe_reg_err_code

  class keymgr_dpe_reg_fault_status extends dv_base_reg;
    // fields
    ...
    `uvm_object_utils(keymgr_dpe_reg_fault_status)
  ...
  endclass : keymgr_dpe_reg_fault_status

  class keymgr_dpe_reg_debug extends dv_base_reg;
    // fields
    ...
    rand dv_base_reg_field invalid_root_key;
    rand dv_base_reg_field inactive_lc_en;

    `uvm_object_utils(keymgr_dpe_reg_debug)
    ...
    virtual function void build(csr_excl_item csr_excl = null);
      ...
      invalid_root_key =
          (dv_base_reg_field::
           type_id::create("invalid_root_key"));
      invalid_root_key.configure(
        .parent(this),
        .size(1),
        .lsb_pos(7),
        .access("W0C"),
      ...
      invalid_root_key.set_original_access("W0C");
      inactive_lc_en =
          (dv_base_reg_field::
           type_id::create("inactive_lc_en"));
      inactive_lc_en.configure(
        .parent(this),
        .size(1),
        .lsb_pos(8),
        .access("W0C"),
      ...
      inactive_lc_en.set_original_access("W0C");
    endfunction : build
  endclass : keymgr_dpe_reg_debug

  class keymgr_dpe_reg_block extends dv_base_reg_block;
    // registers
    rand keymgr_dpe_reg_intr_state intr_state;
    rand keymgr_dpe_reg_intr_enable intr_enable;
    rand keymgr_dpe_reg_intr_test intr_test;
    rand keymgr_dpe_reg_alert_test alert_test;
    rand keymgr_dpe_reg_cfg_regwen cfg_regwen;
    rand keymgr_dpe_reg_start start;
    rand keymgr_dpe_reg_control_shadowed control_shadowed;
    rand keymgr_dpe_reg_sideload_clear sideload_clear;
    rand keymgr_dpe_reg_reseed_interval_regwen reseed_interval_regwen;
    rand keymgr_dpe_reg_reseed_interval_shadowed reseed_interval_shadowed;
    rand keymgr_dpe_reg_slot_policy_regwen slot_policy_regwen;
    rand keymgr_dpe_reg_slot_policy slot_policy;
    rand keymgr_dpe_reg_sw_binding_regwen sw_binding_regwen;
    rand keymgr_dpe_reg_sw_binding sw_binding[8];
    rand keymgr_dpe_reg_salt salt[8];
    rand keymgr_dpe_reg_key_version key_version[1];
    rand keymgr_dpe_reg_max_key_ver_regwen max_key_ver_regwen;
    rand keymgr_dpe_reg_max_key_ver_shadowed max_key_ver_shadowed;
    rand keymgr_dpe_reg_sw_share0_output sw_share0_output[8];
    rand keymgr_dpe_reg_sw_share1_output sw_share1_output[8];
    rand keymgr_dpe_reg_working_state working_state;
    rand keymgr_dpe_reg_op_status op_status;
    rand keymgr_dpe_reg_err_code err_code;
    rand keymgr_dpe_reg_fault_status fault_status;
    rand keymgr_dpe_reg_debug debug;

    `uvm_object_utils(keymgr_dpe_reg_block)
    ...
    virtual function void build(uvm_reg_addr_t base_addr,
      ...
      control_shadowed =
          (keymgr_dpe_reg_control_shadowed::
      ...
      control_shadowed.add_hdl_path_slice(
          "u_reg.u_control_shadowed_slot_src_sel.committed_reg.q",
          14, 2, 0, "BkdrRegPathRtl");
      control_shadowed.add_hdl_path_slice(
          "u_reg.u_control_shadowed_slot_src_sel.shadow_reg.q",
          14, 2, 0, "BkdrRegPathRtlShadow");
      control_shadowed.add_hdl_path_slice(
          "u_reg.u_control_shadowed_slot_dst_sel.committed_reg.q",
          18, 2, 0, "BkdrRegPathRtl");
      control_shadowed.add_hdl_path_slice(
          "u_reg.u_control_shadowed_slot_dst_sel.shadow_reg.q",
          18, 2, 0, "BkdrRegPathRtlShadow");

      control_shadowed.set_is_shadowed();
      sideload_clear =
          (keymgr_dpe_reg_sideload_clear::
      ...
      reseed_interval_regwen =
          (keymgr_dpe_reg_reseed_interval_regwen::
      ...
      // create register tags
      csr_excl.add_excl(reseed_interval_regwen.get_full_name(),
                        CsrExclWrite, CsrAllTests);
      reseed_interval_shadowed =
          (keymgr_dpe_reg_reseed_interval_shadowed::
      ...
      slot_policy_regwen =
          (keymgr_dpe_reg_slot_policy_regwen::
           type_id::create("slot_policy_regwen"));
      slot_policy_regwen.configure(.blk_parent(this));
      slot_policy_regwen.build(csr_excl);
      default_map.add_reg(.rg(slot_policy_regwen),
                          .offset(32'h28));
      slot_policy_regwen.add_hdl_path_slice(
          "u_reg.u_slot_policy_regwen.qs",
          0, 1, 0, "BkdrRegPathRtl");

      // create register tags
      csr_excl.add_excl(slot_policy_regwen.get_full_name(),
                        CsrExclWrite, CsrAllTests);
      slot_policy =
          (keymgr_dpe_reg_slot_policy::
           type_id::create("slot_policy"));
      slot_policy.configure(.blk_parent(this));
      slot_policy.build(csr_excl);
      default_map.add_reg(.rg(slot_policy),
                          .offset(32'h2c));
      slot_policy.add_hdl_path_slice(
          "u_reg.u_slot_policy_allow_child.q",
          0, 1, 0, "BkdrRegPathRtl");
      slot_policy.add_hdl_path_slice(
          "u_reg.u_slot_policy_exportable.q",
          1, 1, 0, "BkdrRegPathRtl");
      slot_policy.add_hdl_path_slice(
          "u_reg.u_slot_policy_retain_parent.q",
          2, 1, 0, "BkdrRegPathRtl");

      sw_binding_regwen =
          (keymgr_dpe_reg_sw_binding_regwen::
      ...
      // create register tags
      csr_excl.add_excl(sw_binding_regwen.get_full_name(),
                        CsrExclWrite, CsrAllTests);
      sw_binding[0] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_0"));
      sw_binding[0].configure(.blk_parent(this));
      sw_binding[0].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[0]),
                          .offset(32'h34));
      sw_binding[0].add_hdl_path_slice(
          "u_reg.u_sw_binding_0.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[1] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_1"));
      sw_binding[1].configure(.blk_parent(this));
      sw_binding[1].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[1]),
                          .offset(32'h38));
      sw_binding[1].add_hdl_path_slice(
          "u_reg.u_sw_binding_1.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[2] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_2"));
      sw_binding[2].configure(.blk_parent(this));
      sw_binding[2].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[2]),
                          .offset(32'h3c));
      sw_binding[2].add_hdl_path_slice(
          "u_reg.u_sw_binding_2.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[3] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_3"));
      sw_binding[3].configure(.blk_parent(this));
      sw_binding[3].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[3]),
                          .offset(32'h40));
      sw_binding[3].add_hdl_path_slice(
          "u_reg.u_sw_binding_3.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[4] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_4"));
      sw_binding[4].configure(.blk_parent(this));
      sw_binding[4].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[4]),
                          .offset(32'h44));
      sw_binding[4].add_hdl_path_slice(
          "u_reg.u_sw_binding_4.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[5] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_5"));
      sw_binding[5].configure(.blk_parent(this));
      sw_binding[5].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[5]),
                          .offset(32'h48));
      sw_binding[5].add_hdl_path_slice(
          "u_reg.u_sw_binding_5.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[6] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_6"));
      sw_binding[6].configure(.blk_parent(this));
      sw_binding[6].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[6]),
                          .offset(32'h4c));
      sw_binding[6].add_hdl_path_slice(
          "u_reg.u_sw_binding_6.q",
          0, 32, 0, "BkdrRegPathRtl");

      sw_binding[7] =
          (keymgr_dpe_reg_sw_binding::
           type_id::create("sw_binding_7"));
      sw_binding[7].configure(.blk_parent(this));
      sw_binding[7].build(csr_excl);
      default_map.add_reg(.rg(sw_binding[7]),
                          .offset(32'h50));
      sw_binding[7].add_hdl_path_slice(
          "u_reg.u_sw_binding_7.q",
          0, 32, 0, "BkdrRegPathRtl");
      ...
      max_key_ver_regwen =
          (keymgr_dpe_reg_max_key_ver_regwen::
           type_id::create("max_key_ver_regwen"));
      max_key_ver_regwen.configure(.blk_parent(this));
      max_key_ver_regwen.build(csr_excl);
      default_map.add_reg(.rg(max_key_ver_regwen),
                          .offset(32'h78));
      max_key_ver_regwen.add_hdl_path_slice(
          "u_reg.u_max_key_ver_regwen.qs",
          0, 1, 0, "BkdrRegPathRtl");

      // create register tags
      csr_excl.add_excl(max_key_ver_regwen.get_full_name(),
                        CsrExclWrite, CsrAllTests);
      max_key_ver_shadowed =
          (keymgr_dpe_reg_max_key_ver_shadowed::
           type_id::create("max_key_ver_shadowed"));
      max_key_ver_shadowed.configure(.blk_parent(this));
      max_key_ver_shadowed.build(csr_excl);
      default_map.add_reg(.rg(max_key_ver_shadowed),
                          .offset(32'h7c));
      max_key_ver_shadowed.add_update_err_alert("recov_operation_err");

      max_key_ver_shadowed.add_storage_err_alert("fatal_fault_err");

      max_key_ver_shadowed.add_hdl_path_slice(
          "u_reg.u_max_key_ver_shadowed.committed_reg.q",
          0, 32, 0, "BkdrRegPathRtl");
      max_key_ver_shadowed.add_hdl_path_slice(
          "u_reg.u_max_key_ver_shadowed.shadow_reg.q",
          0, 32, 0, "BkdrRegPathRtlShadow");

      max_key_ver_shadowed.set_is_shadowed();
      sw_share0_output[0] =
          (keymgr_dpe_reg_sw_share0_output::
      ...
      csr_excl.add_excl(sw_share0_output[7].get_full_name(),
                        CsrExclCheck, CsrNonInitTests);
      sw_share1_output[0] =
          (keymgr_dpe_reg_sw_share1_output::
      ...
      debug.add_hdl_path_slice(
          ...
          6, 1, 0, "BkdrRegPathRtl");
      debug.add_hdl_path_slice(
          "u_reg.u_debug_invalid_root_key.q",
          7, 1, 0, "BkdrRegPathRtl");
      debug.add_hdl_path_slice(
          "u_reg.u_debug_inactive_lc_en.q",
          8, 1, 0, "BkdrRegPathRtl");
      ...
      slot_policy_regwen.add_lockable_reg_or_fld(slot_policy);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[0]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[1]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[2]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[3]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[4]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[5]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[6]);
      sw_binding_regwen.add_lockable_reg_or_fld(sw_binding[7]);
      ...
      max_key_ver_regwen.add_lockable_reg_or_fld(max_key_ver_shadowed);
