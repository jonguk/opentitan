...
class spi_host_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(spi_host_bit_bash_seq);
  explicit spi_host_bit_bash_seq(const std::string &nm = "spi_host_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
