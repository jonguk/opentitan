...
#include "otp_macro_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class otp_macro_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(otp_macro_csr_rw_test);
  otp_macro_env* m_env {};
  explicit otp_macro_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = otp_macro_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(otp_macro_csr_rw_test);
