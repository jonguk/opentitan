...
class otp_macro_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otp_macro_bit_bash_seq);
  explicit otp_macro_bit_bash_seq(const std::string &nm = "otp_macro_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
