...
class otp_macro_wo_rc_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otp_macro_wo_rc_seq);
  explicit otp_macro_wo_rc_seq(const std::string &nm = "otp_macro_wo_rc_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
