...
class otp_macro_tlul_err_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otp_macro_tlul_err_seq);
  explicit otp_macro_tlul_err_seq(const std::string &nm = "otp_macro_tlul_err_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
