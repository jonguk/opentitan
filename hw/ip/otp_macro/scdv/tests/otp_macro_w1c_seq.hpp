...
class otp_macro_w1c_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(otp_macro_w1c_seq);
  explicit otp_macro_w1c_seq(const std::string &nm = "otp_macro_w1c_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
    ...
    wr_set->a_opcode = tl_a_op_e::PutFullData; wr_set->a_addr = 0; wr_set->a_size = 2; wr_set->a_mask = 0xF; wr_set->a_data = 1u;
