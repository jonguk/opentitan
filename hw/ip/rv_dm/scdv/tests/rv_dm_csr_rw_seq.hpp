...
class rv_dm_csr_rw_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(rv_dm_csr_rw_seq);
  explicit rv_dm_csr_rw_seq(const std::string &nm = "rv_dm_csr_rw_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
