...
#include "rv_dm_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class rv_dm_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(rv_dm_csr_rw_test);
  rv_dm_env* m_env {};
  explicit rv_dm_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = rv_dm_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(rv_dm_csr_rw_test);
