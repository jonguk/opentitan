...
class rom_ctrl_wo_rc_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(rom_ctrl_wo_rc_seq);
  explicit rom_ctrl_wo_rc_seq(const std::string &nm = "rom_ctrl_wo_rc_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
