...
package rom_ctrl_rom_ral_pkg;
  ...
  typedef class rom_ctrl_rom_reg_block;

  class rom_ctrl_rom_reg_block extends dv_base_reg_block;

    `uvm_object_utils(rom_ctrl_rom_reg_block)
  ...
  endclass : rom_ctrl_rom_reg_block
