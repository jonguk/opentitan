...
class lc_ctrl_csr_rw_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(lc_ctrl_csr_rw_seq);
  explicit lc_ctrl_csr_rw_seq(const std::string &nm = "lc_ctrl_csr_rw_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
