...
#include "lc_ctrl_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class lc_ctrl_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(lc_ctrl_csr_rw_test);
  lc_ctrl_env* m_env {};
  explicit lc_ctrl_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = lc_ctrl_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(lc_ctrl_csr_rw_test);
