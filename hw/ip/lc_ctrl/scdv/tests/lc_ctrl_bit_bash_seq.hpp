...
class lc_ctrl_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(lc_ctrl_bit_bash_seq);
  explicit lc_ctrl_bit_bash_seq(const std::string &nm = "lc_ctrl_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
