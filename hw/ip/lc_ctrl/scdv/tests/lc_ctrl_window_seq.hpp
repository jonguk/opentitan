...
class lc_ctrl_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(lc_ctrl_window_seq);
  explicit lc_ctrl_window_seq(const std::string &nm = "lc_ctrl_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
