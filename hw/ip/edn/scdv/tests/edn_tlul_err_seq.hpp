...
class edn_tlul_err_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(edn_tlul_err_seq);
  explicit edn_tlul_err_seq(const std::string &nm = "edn_tlul_err_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
