...
class edn_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(edn_window_seq);
  explicit edn_window_seq(const std::string &nm = "edn_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
