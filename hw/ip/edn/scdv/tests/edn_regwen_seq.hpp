...
class edn_regwen_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(edn_regwen_seq);
  explicit edn_regwen_seq(const std::string &nm = "edn_regwen_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
