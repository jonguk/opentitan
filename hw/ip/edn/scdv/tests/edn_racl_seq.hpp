...
class edn_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(edn_racl_seq);
  explicit edn_racl_seq(const std::string &nm = "edn_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
