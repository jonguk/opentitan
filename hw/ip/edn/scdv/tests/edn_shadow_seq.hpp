...
class edn_shadow_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(edn_shadow_seq);
  explicit edn_shadow_seq(const std::string &nm = "edn_shadow_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
