...
class adc_ctrl_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(adc_ctrl_window_seq);
  explicit adc_ctrl_window_seq(const std::string &nm = "adc_ctrl_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
