...
namespace scdv {
  ...
  { "STATUS", ExclWrite },
  { "LAST_READ_ADDR", ExclWrite },
  { "UPLOAD_STATUS", ExclWrite },
  { "UPLOAD_STATUS2", ExclWrite },
  { "UPLOAD_CMDFIFO", ExclWrite },
  { "UPLOAD_ADDRFIFO", ExclWrite },
  { "TPM_CAP", ExclWrite },
  { "TPM_CMD_ADDR", ExclWrite },
  { "TPM_READ_FIFO", ExclRead }
    };
