...
class spi_device_w1c_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(spi_device_w1c_seq);
  explicit spi_device_w1c_seq(const std::string &nm = "spi_device_w1c_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
