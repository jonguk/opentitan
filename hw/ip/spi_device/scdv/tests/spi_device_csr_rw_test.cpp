...
#include "spi_device_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class spi_device_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(spi_device_csr_rw_test);
  spi_device_env* m_env {};
  explicit spi_device_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = spi_device_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(spi_device_csr_rw_test);
