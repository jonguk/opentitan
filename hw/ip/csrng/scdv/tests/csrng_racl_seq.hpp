...
class csrng_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(csrng_racl_seq);
  explicit csrng_racl_seq(const std::string &nm = "csrng_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
