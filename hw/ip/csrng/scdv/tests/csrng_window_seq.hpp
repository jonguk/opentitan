...
class csrng_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(csrng_window_seq);
  explicit csrng_window_seq(const std::string &nm = "csrng_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
