...
class soc_dbg_ctrl_tlul_err_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(soc_dbg_ctrl_tlul_err_seq);
  explicit soc_dbg_ctrl_tlul_err_seq(const std::string &nm = "soc_dbg_ctrl_tlul_err_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
