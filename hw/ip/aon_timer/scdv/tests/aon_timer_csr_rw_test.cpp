...
#include "aon_timer_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class aon_timer_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(aon_timer_csr_rw_test);
  aon_timer_env* m_env {};
  explicit aon_timer_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = aon_timer_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(aon_timer_csr_rw_test);
