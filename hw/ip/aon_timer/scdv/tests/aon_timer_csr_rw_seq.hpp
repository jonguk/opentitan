...
class aon_timer_csr_rw_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(aon_timer_csr_rw_seq);
  explicit aon_timer_csr_rw_seq(const std::string &nm = "aon_timer_csr_rw_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
    ...
    const uint32_t offs[] = { 4, 12, 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48 };
    const uint32_t wmask[] = { 0xffffffff, 0x0, 0x1fff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x1, 0x3, 0xffffffff, 0xffffffff, 0xffffffff, 0x0, 0x0, 0x1 };
    const uint32_t womask[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffffff, 0x0 };
    const uint32_t w1cmask[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffffff, 0x0, 0x0 };
    const uint32_t rcmask[] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0 };
