...
class aon_timer_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(aon_timer_bit_bash_seq);
  explicit aon_timer_bit_bash_seq(const std::string &nm = "aon_timer_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
