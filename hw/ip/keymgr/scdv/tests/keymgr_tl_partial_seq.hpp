...
class keymgr_tl_partial_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(keymgr_tl_partial_seq);
  explicit keymgr_tl_partial_seq(const std::string &nm = "keymgr_tl_partial_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
