...
class keymgr_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(keymgr_bit_bash_seq);
  explicit keymgr_bit_bash_seq(const std::string &nm = "keymgr_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
