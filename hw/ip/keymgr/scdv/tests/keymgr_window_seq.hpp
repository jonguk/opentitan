...
class keymgr_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(keymgr_window_seq);
  explicit keymgr_window_seq(const std::string &nm = "keymgr_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
