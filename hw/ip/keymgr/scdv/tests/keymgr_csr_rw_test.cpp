...
#include "keymgr_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class keymgr_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(keymgr_csr_rw_test);
  keymgr_env* m_env {};
  explicit keymgr_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = keymgr_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(keymgr_csr_rw_test);
