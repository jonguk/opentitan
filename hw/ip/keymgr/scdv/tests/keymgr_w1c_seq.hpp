...
class keymgr_w1c_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(keymgr_w1c_seq);
  explicit keymgr_w1c_seq(const std::string &nm = "keymgr_w1c_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
