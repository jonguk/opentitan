...
class keymgr_csr_rw_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(keymgr_csr_rw_seq);
  explicit keymgr_csr_rw_seq(const std::string &nm = "keymgr_csr_rw_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
    ...
    const uint32_t wmask[] = { 0x0, 0xffffffff, 0x0, 0x0, 0x0, 0x1, 0x30f0, 0x7, 0x1, 0xffff, 0x1, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0x1, 0xffffffff, 0x1, 0xffffffff, 0x1, 0xffffffff, 0xffffffff, 0xffffffff, 0x0, 0x0, 0x0, 0x0, 0x7f };
    ...
    const uint32_t w1cmask[] = { 0xffffffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x7, 0x0, 0x0 };
