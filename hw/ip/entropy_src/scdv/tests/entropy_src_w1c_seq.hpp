...
class entropy_src_w1c_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(entropy_src_w1c_seq);
  explicit entropy_src_w1c_seq(const std::string &nm = "entropy_src_w1c_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
