...
class entropy_src_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(entropy_src_bit_bash_seq);
  explicit entropy_src_bit_bash_seq(const std::string &nm = "entropy_src_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
