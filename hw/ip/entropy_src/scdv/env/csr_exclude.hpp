...
namespace scdv {
  ...
  { "REGWEN", ExclWrite },
  { "ENTROPY_DATA", ExclWrite },
  { "REPCNT_HI_WATERMARKS", ExclWrite },
  { "REPCNTS_HI_WATERMARKS", ExclWrite },
  { "ADAPTP_HI_WATERMARKS", ExclWrite },
  { "ADAPTP_LO_WATERMARKS", ExclWrite },
  { "EXTHT_HI_WATERMARKS", ExclWrite },
  { "EXTHT_LO_WATERMARKS", ExclWrite },
  { "BUCKET_HI_WATERMARKS", ExclWrite },
  { "MARKOV_HI_WATERMARKS", ExclWrite },
  { "MARKOV_LO_WATERMARKS", ExclWrite },
  { "REPCNT_TOTAL_FAILS", ExclWrite },
  { "REPCNTS_TOTAL_FAILS", ExclWrite },
  { "ADAPTP_HI_TOTAL_FAILS", ExclWrite },
  { "ADAPTP_LO_TOTAL_FAILS", ExclWrite },
  { "BUCKET_TOTAL_FAILS", ExclWrite },
  { "MARKOV_HI_TOTAL_FAILS", ExclWrite },
  { "MARKOV_LO_TOTAL_FAILS", ExclWrite },
  { "EXTHT_HI_TOTAL_FAILS", ExclWrite },
  { "EXTHT_LO_TOTAL_FAILS", ExclWrite },
  { "ALERT_SUMMARY_FAIL_COUNTS", ExclWrite },
  { "ALERT_FAIL_COUNTS", ExclWrite },
  { "EXTHT_FAIL_COUNTS", ExclWrite },
  { "FW_OV_WR_FIFO_FULL", ExclWrite },
  { "FW_OV_RD_FIFO_OVERFLOW", ExclWrite },
  { "FW_OV_RD_DATA", ExclWrite },
  { "FW_OV_WR_DATA", ExclRead },
  { "OBSERVE_FIFO_DEPTH", ExclWrite },
  { "DEBUG_STATUS", ExclWrite },
  { "ERR_CODE", ExclWrite },
  { "MAIN_SM_STATE", ExclWrite }
    };
