...
class pattgen_tlul_err_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(pattgen_tlul_err_seq);
  explicit pattgen_tlul_err_seq(const std::string &nm = "pattgen_tlul_err_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
