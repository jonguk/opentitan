...
class pattgen_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(pattgen_window_seq);
  explicit pattgen_window_seq(const std::string &nm = "pattgen_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
