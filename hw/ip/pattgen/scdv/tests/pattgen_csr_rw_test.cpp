...
#include "pattgen_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class pattgen_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(pattgen_csr_rw_test);
  pattgen_env* m_env {};
  explicit pattgen_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = pattgen_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(pattgen_csr_rw_test);
