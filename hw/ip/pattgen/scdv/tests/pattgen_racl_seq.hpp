...
class pattgen_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(pattgen_racl_seq);
  explicit pattgen_racl_seq(const std::string &nm = "pattgen_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
