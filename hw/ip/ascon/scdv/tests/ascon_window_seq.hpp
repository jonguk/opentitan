...
class ascon_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(ascon_window_seq);
  explicit ascon_window_seq(const std::string &nm = "ascon_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
