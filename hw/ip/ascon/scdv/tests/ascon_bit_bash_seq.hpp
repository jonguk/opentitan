...
class ascon_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(ascon_bit_bash_seq);
  explicit ascon_bit_bash_seq(const std::string &nm = "ascon_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
