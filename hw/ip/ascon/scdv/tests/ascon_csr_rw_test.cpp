...
#include "ascon_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class ascon_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(ascon_csr_rw_test);
  ascon_env* m_env {};
  explicit ascon_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = ascon_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(ascon_csr_rw_test);
