...
class dma_shadow_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(dma_shadow_seq);
  explicit dma_shadow_seq(const std::string &nm = "dma_shadow_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
