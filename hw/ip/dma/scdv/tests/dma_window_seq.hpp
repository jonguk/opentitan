...
class dma_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(dma_window_seq);
  explicit dma_window_seq(const std::string &nm = "dma_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
