...
class dma_wo_rc_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(dma_wo_rc_seq);
  explicit dma_wo_rc_seq(const std::string &nm = "dma_wo_rc_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
