...
class dma_bit_bash_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(dma_bit_bash_seq);
  explicit dma_bit_bash_seq(const std::string &nm = "dma_bit_bash_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
