...
class dma_regwen_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(dma_regwen_seq);
  explicit dma_regwen_seq(const std::string &nm = "dma_regwen_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
