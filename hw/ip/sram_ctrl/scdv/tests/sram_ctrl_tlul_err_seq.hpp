...
class sram_ctrl_tlul_err_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(sram_ctrl_tlul_err_seq);
  explicit sram_ctrl_tlul_err_seq(const std::string &nm = "sram_ctrl_tlul_err_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
