...
#include "../../tlm/sram_ctrl_reg_pkg.hpp"
using namespace uvm;
...
int sc_main(int argc, char **argv) {
  struct top : sc_core::sc_module {
    ...
    opentitan::sram_ctrl::sram_ctrl_reg_top dut;
    SC_HAS_PROCESS(top);
  ...
  tl_bind::ral_num_bytes = [&](){ return static_cast<uint32_t>(opentitan::sram_ctrl::sram_ctrl_reg_top::kRegBytes); };
