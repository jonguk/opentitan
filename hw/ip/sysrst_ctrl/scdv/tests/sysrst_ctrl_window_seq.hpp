...
class sysrst_ctrl_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(sysrst_ctrl_window_seq);
  explicit sysrst_ctrl_window_seq(const std::string &nm = "sysrst_ctrl_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
