...
class hmac_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(hmac_racl_seq);
  explicit hmac_racl_seq(const std::string &nm = "hmac_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
