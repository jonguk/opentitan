...
class hmac_wo_rc_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(hmac_wo_rc_seq);
  explicit hmac_wo_rc_seq(const std::string &nm = "hmac_wo_rc_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
