...
class hmac_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(hmac_window_seq);
  explicit hmac_window_seq(const std::string &nm = "hmac_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
