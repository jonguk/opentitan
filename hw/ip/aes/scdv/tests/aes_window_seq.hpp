...
class aes_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(aes_window_seq);
  explicit aes_window_seq(const std::string &nm = "aes_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
