...
class aes_shadow_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(aes_shadow_seq);
  explicit aes_shadow_seq(const std::string &nm = "aes_shadow_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
