...
#include "i2c_csr_rw_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
using namespace uvm;

class i2c_csr_rw_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(i2c_csr_rw_test);
  i2c_env* m_env {};
  explicit i2c_csr_rw_test(uvm_component_name nm) : uvm_test(nm) {}
  ...
  void run_phase(uvm_phase &phase) override {
    ...
    auto seq = i2c_csr_rw_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(i2c_csr_rw_test);
