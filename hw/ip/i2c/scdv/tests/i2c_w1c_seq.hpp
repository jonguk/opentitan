...
class i2c_w1c_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(i2c_w1c_seq);
  explicit i2c_w1c_seq(const std::string &nm = "i2c_w1c_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
