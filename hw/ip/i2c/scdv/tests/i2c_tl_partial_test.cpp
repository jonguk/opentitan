...
#include "i2c_tl_partial_seq.hpp"
#include "../../../dv/sc/tl_agent/tl_sequencer.hpp"
#include "../../../dv/sc/tl_agent/seq_lib/tl_seq_list.hpp"
using namespace uvm;

class i2c_tl_partial_test : public uvm_test {
 public:
  UVM_COMPONENT_UTILS(i2c_tl_partial_test);
  i2c_env* m_env {};
  explicit i2c_tl_partial_test(uvm_component_name nm) : uvm_test(nm) {}
  void build_phase(uvm_phase &phase) override { m_env = i2c_env::type_id::create("env", this); }
  void run_phase(uvm_phase &phase) override {
    phase.raise_objection(this);
    auto seq = i2c_tl_partial_seq::type_id::create("seq");
...
UVM_COMPONENT_REGISTER(i2c_tl_partial_test);
