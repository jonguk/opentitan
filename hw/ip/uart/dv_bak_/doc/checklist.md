...
-->
This checklist is for [Hardware Stage](/doc/project_governance/development_stages.md) transitions for the [UART peripheral.](../README.md)
...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Not Started | [UART Design Spec](../README.md)
...
### V1
 ...
 Type         | Item                                  | Resolution  | Note/Collaterals
--------------|---------------------------------------|-------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Not Started | [UART DV document](../dv/README.md)
Documentation | [TESTPLAN_COMPLETED][]                | Not Started | [UART Testplan](../dv/README.md#testplan)
