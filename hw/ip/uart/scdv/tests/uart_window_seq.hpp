...
class uart_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(uart_window_seq);
  explicit uart_window_seq(const std::string &nm = "uart_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
