...
class uart_csr_rw_seq : public uvm::uvm_sequence<tl_item> {
 public:
  ...
  void body() override {
    ...
    const uint32_t wmask[] = { 0x0, 0xffffffff, 0x0, 0x0, 0xffff03f7, 0x0, 0x0, 0x0, 0xfc, 0x0, 0x3, 0x0, 0x80ffffff };
    const uint32_t womask[] = { 0x0, 0x0, 0xffffffff, 0x0, 0x0, 0x0, 0x0, 0xff, 0x3, 0x0, 0x0, 0x0, 0x0 };
