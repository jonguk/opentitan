...
class usbdev_wo_rc_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(usbdev_wo_rc_seq);
  explicit usbdev_wo_rc_seq(const std::string &nm = "usbdev_wo_rc_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
