...
class usbdev_window_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(usbdev_window_seq);
  explicit usbdev_window_seq(const std::string &nm = "usbdev_window_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
