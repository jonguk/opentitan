...
class usbdev_racl_seq : public uvm::uvm_sequence<tl_item> {
 public:
  UVM_OBJECT_UTILS(usbdev_racl_seq);
  explicit usbdev_racl_seq(const std::string &nm = "usbdev_racl_seq") : uvm::uvm_sequence<tl_item>(nm) {}
  void body() override {
